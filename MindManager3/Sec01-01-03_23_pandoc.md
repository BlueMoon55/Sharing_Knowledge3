...
### 国の「サイバーセキュリティ戦略」に沿ったセキュリティ対策を実施するために {#国のサイバーセキュリティ戦略に沿ったセキュリティ対策を実施するために .list-paragraph}
...
### ケーススタディーX：セキュリティ対策を怠ると他社に迷惑をかけることもある {#ケーススタディーxセキュリティ対策を怠ると他社に迷惑をかけることもある .list-paragraph}
...
### 改訂のポイント {#改訂のポイント .list-paragraph}
...
### ＜個別のパソコンに導入するタイプ＞ {#個別のパソコンに導入するタイプ .list-paragraph}
...
## 2-5：パスワードの管理 {#パスワードの管理 .list-paragraph}
...
### ＜情報へのアクセス管理＞ {#情報へのアクセス管理 .list-paragraph}
...
### 添付ファイルはなるべく減らす！ {#添付ファイルはなるべく減らす .list-paragraph}
...
## 2-11：迷惑メール発信への対応 {#迷惑メール発信への対応 .list-paragraph}
...
取組3で定めた情報セキュリティ対策について、 定期または随時に見直して、
...
### 【補足説明材料】 {#補足説明材料-22 .list-paragraph}
...
> [[http://www.meti.go.jp/press/2015/12/20151228002/20151228002-2.pdf]{.underline}](http://www.meti.go.jp/press/2015/12/20151228002/20151228002-2.pdf);

【旧版】中小企業の情報セキュリティ対策ガイドライン（第2版）

（１）経営者のリーダーシップが重要。 経営者は、 IT活用を推進する中で、
サイバーセキュリティリスクを認識し、
...
平時及び緊急時のいずれにおいても、 サイバーセキュリティリスクや対策、
...
## 3-10：【経営者がやらなければならない】サイバーセキュリティ経営の重要10項目 {#経営者がやらなければならないサイバーセキュリティ経営の重要10項目 .list-paragraph}

###  経済産業省と情報処理推進機構（IPA）がまとめた「サイバーセキュリティ経営ガイドラインVer2.0」を基に、経営者が情報セキュリティ全般を統括する「最高情報セキュリティ責任者（CISO）」に指示すべき重要10項目をまとめました。 {#経済産業省と情報処理推進機構ipaがまとめたサイバーセキュリティ経営ガイドラインver2.0を基に経営者が情報セキュリティ全般を統括する最高情報セキュリティ責任者cisoに指示すべき重要10項目をまとめました .list-paragraph}

### 【補足説明材料】 {#補足説明材料-26 .list-paragraph}
...
### ３．１．サイバーセキュリティリスクの管理体制構築 {#サイバーセキュリティリスクの管理体制構築 .list-paragraph}
...
### ３．２．サイバーセキュリティリスクの特定と対策の実装 {#サイバーセキュリティリスクの特定と対策の実装 .list-paragraph}
...
### ３．３．インシデント発生に備えた体制構築 3 {#インシデント発生に備えた体制構築-3 .list-paragraph}
...
・法的な取り決めがあり、 所管官庁等への報告が義務づけられている場合、
速やかな通知がないことにより、 罰則等を受ける場合がある。
...
### ３．４．サプライチェーンセキュリティ対策の推進 {#サプライチェーンセキュリティ対策の推進 .list-paragraph}
...
> [[https://www.ipa.go.jp/security/security-action/]{.underline}](https://www.ipa.go.jp/security/security-action/);
...
### ３．５．ステークホルダーを含めた関係者とのコミュニケーションの推進 {#ステークホルダーを含めた関係者とのコミュニケーションの推進 .list-paragraph}

指示１０ 情報共有活動への参加を通じた攻撃情報の入手とその有効活用及び
提供
...
・情報共有活動への参加により、 解析した攻撃手法などの情報を用いて、
他社における同様の被害を未然に防止することができるが、
情報共有ができていないと、社会全体において常に新たな攻撃として対応することとなり、
企業における対応コストが低減しない。

## 【補足説明材料】 {#補足説明材料-27 .list-paragraph}

### 【Web版コラム】サイバーセキュリティ経営ガイドライン実践状況の可視化ツールβ版 {#web版コラムサイバーセキュリティ経営ガイドライン実践状況の可視化ツールβ版 .list-paragraph}

可視化ツールβ版について

> [[https://www.ipa.go.jp/security/economics/checktool/]{.underline}](https://www.ipa.go.jp/security/economics/checktool/);
...
> [[https://www.ipa.go.jp/files/000081169.xlsx]{.underline}](https://www.ipa.go.jp/files/000081169.xlsx);

### 【Web版コラム】サイバーセキュリティ経営ガイドライン 実践のためのプラクティス {#web版コラムサイバーセキュリティ経営ガイドライン-実践のためのプラクティス .list-paragraph}

サイバーセキュリティ経営ガイドライン 実践のためのプラクティス集第2版

> [[https://www.ipa.go.jp/files/000072309.pdf]{.underline}](https://www.ipa.go.jp/files/000072309.pdf);

# 【Mission03-B】経営者は事前に何を備えればよいのか【攻め】 {#mission03-b経営者は事前に何を備えればよいのか攻め .list-paragraph}

## 概要 {#概要-3 .list-paragraph}

### 3-B-1:ビジネスを発展させるために(攻めのIT投資とサイバーセキュリティ対策) {#b-1ビジネスを発展させるために攻めのit投資とサイバーセキュリティ対策 .list-paragraph}

【持続的発展のため】組織の発展を目指した戦略的なIT活用とサイバーセキュリティ対策

## Mission3-11 次世代技術を活用したビジネス展開 {#mission3-11-次世代技術を活用したビジネス展開 .list-paragraph}

### 要旨 {#要旨 .list-paragraph}

【要旨】DX時代→中小も対応しないと→対応するには新たなセキュリティ対策も

### 攻めのIT投資とは？ {#攻めのit投資とは .list-paragraph}
...
### 各種の支援策も充実 {#各種の支援策も充実 .list-paragraph}
...
### 【コラム】DX推進はビジネス飛躍のチャンス {#コラムdx推進はビジネス飛躍のチャンス .list-paragraph}
...
### 【補足説明材料】 {#補足説明材料-28 .list-paragraph}
...
> [[https://www.ipa.go.jp/jinzai/jigyou/about.html]{.underline}](https://www.ipa.go.jp/jinzai/jigyou/about.html);

あらゆるものがインターネットに接続するIoTの広がり、
あらゆる情報がビッグデータとして活用され、 AI技術により、
様々な分野で定型的な業務はもとより、 人海戦術では不可能だった業務まで、
...
DXとは、 あらゆる情報がデジタル化され、 IT技術によって、 社会や産業、
企業、 人のあり方や働き方が変わっていくこと

DXが進むにつれて、 発展するビジネスと縮小するビジネスが明確になっていく

時代環境が大きく変わる時、 それにそぐわないビジネスは淘汰されていく

匠の技的な高度な伝統的技能を要する作業や、
旧来の延長線で仕組みの高度化、 洗練により、 生き残れるビジネスもあるが、
現状維持のビジネスの多くは、 相対的に意義を失う可能性が高い
...
目の前の業務だけにとらわれることなく、
広く視野を持って進むべき道を探り、 学ぶ。 勉強会やコミュニティなど、
学びの場は周囲にある。 自己研さんによって能力を高めれば高めただけ、
社会をリードしていく人材になっていく
...
企業がこれからのビジネスで勝ち残っていくためには、 新しい製品、
サービス、 パートナーシップ、 ビジネスモデルなどを創造し、
...
イノベーションを後押しするIoT、 AIや機械学習などの認知システム、
ロボティクス、 AR（Augmented Reality、 拡張現実）／VR（Virtual Reality、
仮想現実）、 3Dプリンティングなど

デジタルトランスフォーメーション、 インダストリー4.0、 Society5.0、 、
、
...
> [[http://www.nisc.go.jp/active/kihon/pdf/keiei.pdf]{.underline}](http://www.nisc.go.jp/active/kihon/pdf/keiei.pdf);
...
> [[http://www.nikkeibp.co.jp/atcl/tk/DTrans/kmy/]{.underline}](http://www.nikkeibp.co.jp/atcl/tk/DTrans/kmy/);
...
人工知能（AI）, ディープラーニング, ビッグデータ, IoT, M2M.
仮想現実（AR）, ３Dプリンタ等のデジタルを、 ITを駆使した新サービスを、
...
> [[http://www.meti.go.jp/press/2016/07/20160705002/20160705002.html]{.underline}](http://www.meti.go.jp/press/2016/07/20160705002/20160705002.html);

■安全なIoTシステムの創出【2016年3月1日NISC】

> [[http://www.nisc.go.jp/conference/cs/kenkyu/dai03/pdf/03shiryou05.pdf]{.underline}](http://www.nisc.go.jp/conference/cs/kenkyu/dai03/pdf/03shiryou05.pdf);

■コンシューマ向けIoTセキュリティガイド【2016年6月24日JNSA】

> [[http://www.jnsa.org/result/iot/]{.underline}](http://www.jnsa.org/result/iot/);

■IoT早期導入者のためのセキュリティガイダンス【2016年2月24日CSA】

> [[https://www.cloudsecurityalliance.jp/newsite/wp-content/uploads/2016/02/Security_Guidance_for_Early_Adopters_of_the_Internet_of_Things_J\_160224.pdf]{.underline}](https://www.cloudsecurityalliance.jp/newsite/wp-content/uploads/2016/02/Security_Guidance_for_Early_Adopters_of_the_Internet_of_Things_J_160224.pdf);

クラウドサービス

■クラウドセキュリティガイドライン活用ガイドブック2013年版【METI】

> [[http://www.meti.go.jp/press/2013/03/20140314004/20140314004-3.pdf]{.underline}](http://www.meti.go.jp/press/2013/03/20140314004/20140314004-3.pdf);

■クラウドサービス提供における情報セキュリティ対策ガイドライン【2014年4月総務省】

> [[http://www.soumu.go.jp/menu_news/s-news/01ryutsu03_02000073.html]{.underline}](http://www.soumu.go.jp/menu_news/s-news/01ryutsu03_02000073.html);

■クラウドセキュリティ関連ISO規格

ISO/IEC27017:2015に基づくISMSクラウドセキュリティ認証に関する要求事項（スライド）【JIPDEC】

> [[https://www.isms.jipdec.or.jp/doc/JIP-ISMS517-10.pdf]{.underline}](https://www.isms.jipdec.or.jp/doc/JIP-ISMS517-10.pdf);

ISMSクラウドセキュリティ認証の概要（スライド）【JIPDEC】

> [[https://www.isms.jipdec.or.jp/seminar/cloud/shiryou-1.pdf]{.underline}](https://www.isms.jipdec.or.jp/seminar/cloud/shiryou-1.pdf);

ISO/IEC27017:2015に基づくクラウドセキュリティの構築のポイント（スライド）【JIPDEC】

> [[https://www.isms.jipdec.or.jp/seminar/cloud/shiryou-2.pdf]{.underline}](https://www.isms.jipdec.or.jp/seminar/cloud/shiryou-2.pdf);
...
> [[http://www.mri.co.jp/opinion/column/tech/tech_20160520.html]{.underline}](http://www.mri.co.jp/opinion/column/tech/tech_20160520.html);
...
> [[https://www.boj.or.jp/announcements/release_2016/data/rel160831b4.pdf]{.underline}](https://www.boj.or.jp/announcements/release_2016/data/rel160831b4.pdf);
...
NIST SP.800-82R2　Guide to Industrial Control Systems (ICS)
Security　【再掲】
...
Mobile Device Security Corporate-Owned Personally-Enabled (COPE)【NIST
SPECIAL PUBLICATION 1800-21】対応
...
## 3-12：IoT、 ビッグデータ, AI、 ロボットの活用 {#iot-ビッグデータ-ai-ロボットの活用 .list-paragraph}

### 業務・サービスの効率性を追求 {#業務サービスの効率性を追求 .list-paragraph}

あらゆる機器がインターネットに接続することで、人が行ってきたことをセンサー化し、センサーからの膨大なデータを瞬時に分析できます。その結果を踏まえて業務やサービスを効率的、効果的に行うことが始まっています。IoT（Internet
of Things／モノのインターネット）※、ビッグデータ※、AI（Artificial
Intelligence／人工知能）※、ロボットの活用は、人手不足に対応した省力化や、自動化のための投資という面でも期待されています。

※IoT、ビッグデータはP122を、AIはP124を参照

### 【コラム】IoT、ビッグデータ、AI、ロボットはつながっている {#コラムiotビッグデータaiロボットはつながっている .list-paragraph}
...
### 【補足説明材料】 {#補足説明材料-29 .list-paragraph}
...
## 3-13：IoTが果たす役割と効果 {#iotが果たす役割と効果 .list-paragraph}

### IoTは中小企業にとって大きなビジネスチャンス {#iotは中小企業にとって大きなビジネスチャンス .list-paragraph}
...
### 【コラム】中堅・中小企業のIoT活用事例 {#コラム中堅中小企業のiot活用事例 .list-paragraph}
...
### 【補足説明材料】 {#補足説明材料-30 .list-paragraph}
...
> [[https://www.iajapan.org/iot/event/2016/pdf/3_01_sano.pdf]{.underline}](https://www.iajapan.org/iot/event/2016/pdf/3_01_sano.pdf);

IoT、 ビッグデータ、 AI、 ロボットを利用することにより、
人が行ってきたことが効率化されるとともに、
これらを使いこなすことにより、 人の仕事の質を高める能力が付加価値となる

## 3-14：人工知能（AI）が果たす役割と効果 {#人工知能aiが果たす役割と効果 .list-paragraph}

### 急速に進化するAIを活用しよう {#急速に進化するaiを活用しよう .list-paragraph}
...
### 【コラム】新しい価値を持った業務の創出 {#コラム新しい価値を持った業務の創出 .list-paragraph}

AIを含むICTの進化は雇用と働き方にも影響を及ぼします。
・既存業務の人材不足の解消 ・不足している労働力の補完・省力
・既存の業務効率・生産性の向上（省力化） ・新しい価値を持った業務の創出
などが期待されています。 ＜AIの進化で予想されること＞
・労働力不足や過酷労働などの緩和
...
### 【補足説明材料】 {#補足説明材料-31 .list-paragraph}

人工知能は、 中小企業の既存の業務の人材不足の解消に留まらず、
...
> [[http://www.soumu.go.jp/johotsusintokei/whitepaper/h28.html]{.underline}](http://www.soumu.go.jp/johotsusintokei/whitepaper/h28.html);
...
## 3-15：IoTを活用する際のサイバーセキュリティ上の留意点 {#iotを活用する際のサイバーセキュリティ上の留意点 .list-paragraph}

### IoTへの脅威 {#iotへの脅威 .list-paragraph}
...
### 【補足説明材料】 {#補足説明材料-32 .list-paragraph}
...
製造者は、 IoT製品のファームウェアの自動アップデート機能を実装し、
脆弱性に対して速やかに対応する等の「IoT製品ガイドライン」に沿った対応が必要

膨大な情報をビッグデータとして活用に当たっては、
「改訂個人情報保護法」の個人情報に該当する可能性の「グレーゾーン」の情報も増える。
また、 利用の仕方によっては著作権侵害になるケースもある。 さらに、
情報をビッグデータとして公開する際に、 故意・過失に関わらず、
機密性の高い情報を公開してしまう可能性もある

## 3-16：IoTを活用する一般利用者のための基本ルール {#iotを活用する一般利用者のための基本ルール .list-paragraph}

### IoTのセキュリティは製造サービス提供側とサービス利用者側の双方の意識が大切 {#iotのセキュリティは製造サービス提供側とサービス利用者側の双方の意識が大切 .list-paragraph}
...
### IoT機器やシステム、サービスの提供にあたっての指針 {#iot機器やシステムサービスの提供にあたっての指針 .list-paragraph}
...
### IoT機器の一般利用者のためのルール {#iot機器の一般利用者のためのルール .list-paragraph}
...
### Society5.0とIoT {#society5.0とiot .list-paragraph}
...
### コラム　スマート東京実施戦略～東京版Society5.0の実現に向けて {#コラム-スマート東京実施戦略東京版society5.0の実現に向けて .list-paragraph}
...
## 【補足説明材料】 {#補足説明材料-33 .list-paragraph}

### 3-16とコラム併せて大幅に追記する {#とコラム併せて大幅に追記する .list-paragraph}

### 【要旨】IoT, ビッグデータ, AI, ロボット等の新たなIT活用におけるサイバーセキュリティ対策 {#要旨iot-ビッグデータ-ai-ロボット等の新たなit活用におけるサイバーセキュリティ対策 .list-paragraph}

クラウドサービスの活用 「クラウドサービスとは」
具体的な活用事例　IaaS　メール、Apサービス、AWSの事例
「クラウドサービス利用の留意点」

CASYB（Cloud Access Secuity　Broker)のセキュリティ確保機能の事例

### 【コラム】IoT活用企業におけるプライバシー保護に関する考慮事項とは \| PwC Japanグループ {#コラムiot活用企業におけるプライバシー保護に関する考慮事項とは-pwc-japanグループ .list-paragraph}

### 【コラム】サイバー・フジカル・セキュリティ対策フレームワーク対応 NIST　SP800―161　サプライチェーンリスクマネージメント {#コラムサイバーフジカルセキュリティ対策フレームワーク対応-nist-sp800161-サプライチェーンリスクマネージメント .list-paragraph}

### 【コラム】サイバー・フィジカル・セキュリティ対策フレームワーク対応 {#コラムサイバーフィジカルセキュリティ対策フレームワーク対応 .list-paragraph}
...
### 【コラム】NIST SP800-171 「連邦政府外のシステムと組織における管理された非格付け情報の保護」 改訂Revishon2対応 {#コラムnist-sp800-171-連邦政府外のシステムと組織における管理された非格付け情報の保護-改訂revishon2対応 .list-paragraph}

NIST SP 800-171
の要求事項と「サイバー・フィジカル・セキュリティ対策フレームワーク」との対応表

### 【コラム】NIST　SP800-53 「連邦政府情報システムおよび連邦組織のための セキュリティ管理策とプライバシー管理策」改訂Rev4.0対応 {#コラムnist-sp800-53-連邦政府情報システムおよび連邦組織のための-セキュリティ管理策とプライバシー管理策改訂rev4.0対応 .list-paragraph}

# 【Mission04】もしもマニュアル {#mission04もしもマニュアル .list-paragraph}

## 4-1：緊急事態応用マニュアルの作成 {#緊急事態応用マニュアルの作成 .list-paragraph}

## 4-2：基本事項の決定 {#基本事項の決定 .list-paragraph}

## 4-3：漏えい・流出発生時の対応 {#漏えい流出発生時の対応 .list-paragraph}

## 4-4：改ざん・消失・破壊・サービス停止発生時の対応 {#改ざん消失破壊サービス停止発生時の対応 .list-paragraph}

## 4-5：ウイルス感染時の初期対応 {#ウイルス感染時の初期対応 .list-paragraph}

## 4-6：届け出および相談 {#届け出および相談 .list-paragraph}

## 4-7：大規模災害などによる事業中断と事業継続管理 {#大規模災害などによる事業中断と事業継続管理 .list-paragraph}

### 【補足説明材料】 {#補足説明材料-34 .list-paragraph}

IT/BCP　範囲とフレームワーク再検討する

セキュリティ侵害も事業継続を脅かすリスクの一つであり、事業継続計画には、セキュリティ対策の事前対応も含める必要がある

# 【MISSION5】やってみよう！サイバー攻撃対策シミュレーション {#mission5やってみようサイバー攻撃対策シミュレーション .list-paragraph}

## 5-1：サイバー攻撃前夜 {#サイバー攻撃前夜 .list-paragraph}

## 5-2：攻撃発生その瞬間 {#攻撃発生その瞬間 .list-paragraph}

## 5-3：サイバー攻撃直後 {#サイバー攻撃直後 .list-paragraph}

## 5-4：潜入拡大 {#潜入拡大 .list-paragraph}

## 5-5：顧客への被害拡大 取引先への被害拡大 {#顧客への被害拡大-取引先への被害拡大 .list-paragraph}

## 5-6：サイバー攻撃の発覚 {#サイバー攻撃の発覚 .list-paragraph}

## 5-7：原因が判明 ウイルス感染が原因 {#原因が判明-ウイルス感染が原因 .list-paragraph}

## 5-8：再発防止策の作成 {#再発防止策の作成 .list-paragraph}

## 5-9：復旧回復 {#復旧回復 .list-paragraph}

## 5-10：EMOTET、ランサムウェア対策 {#emotetランサムウェア対策 .list-paragraph}

# 【Mission6】　インフォメーション {#mission6-インフォメーション .list-paragraph}

## 6-1：もしかしてサイバー攻撃？ここに連絡を！ {#もしかしてサイバー攻撃ここに連絡を .list-paragraph}

### 警視庁、IPA、東京都？、、？ {#警視庁ipa東京都 .list-paragraph}

## 6-2：その他の主な報告・連絡・相談窓口等 {#その他の主な報告連絡相談窓口等 .list-paragraph}

### 【補足説明材料】 {#補足説明材料-35 .list-paragraph}
...
> [[https://www.ipa.go.jp/security/anshin/]{.underline}](https://www.ipa.go.jp/security/anshin/);
...
> [[http://www.keishicho.metro.tokyo.jp/kurashi/cyber/]{.underline}](http://www.keishicho.metro.tokyo.jp/kurashi/cyber/);
...
> [[https://www.antiphishing.jp/]{.underline}](https://www.antiphishing.jp/);

■迷惑メール相談センター　（日本データ通信協会）

> [[https://www.dekyo.or.jp/soudan/index.html]{.underline}](https://www.dekyo.or.jp/soudan/index.html);
...
> [[https://www.saferinternet.or.jp/narisumashi/]{.underline}](https://www.saferinternet.or.jp/narisumashi/);

違法情報の通報:

> [[https://www.safe-line.jp/report/]{.underline}](https://www.safe-line.jp/report/);

■インターネット上での違法・有害情報の相談・通報

●「違法・有害情報センター」(総務省系)

> [[http://ihaho.jp/]{.underline}](http://ihaho.jp/);
...
> [[http://www.internethotline.jp/pages/about/index]{.underline}](http://www.internethotline.jp/pages/about/index);

■消費生活全般に関する苦情や問合せ

●消費者ホットライン【国民生活センター】☎ 188番

> [[http://www.kokusen.go.jp/map/]{.underline}](http://www.kokusen.go.jp/map/);

■法律相談

●法テラス（日本司法支援センター）☎0570-078374

> [[https://www.houterasu.or.jp/]{.underline}](https://www.houterasu.or.jp/);

■個人情報の取り扱いに関する相談

個人情報保護委員会 ☎ 03-6457-9849

> [[https://www.ppc.go.jp/]{.underline}](https://www.ppc.go.jp/);
...
> [[https://www.jpcert.or.jp/menu_reporttojpcert.html]{.underline}](https://www.jpcert.or.jp/menu_reporttojpcert.html);
...
> [[https://www.ipa.go.jp/security/tokubetsu/index.html]{.underline}](https://www.ipa.go.jp/security/tokubetsu/index.html);
...
## 6-3【Web版】セキュリティお役立ち情報リンク⇒Sec01-01-04内で更新中 {#web版セキュリティお役立ち情報リンクsec01-01-04内で更新中 .list-paragraph}

### Sec01-01-04\_「中小企業向けサイバーセキュリティ対策の極意」(第2版)【追補および解説】で更新継続中 {#sec01-01-04_中小企業向けサイバーセキュリティ対策の極意第2版追補および解説で更新継続中 .list-paragraph}

### 主な文献・リンクのリストアップとそれらを典拠とした内容の要約 {#主な文献リンクのリストアップとそれらを典拠とした内容の要約 .list-paragraph}

### サイバーセキュリティに関連する国等の基本文書、白書、解説文書 {#サイバーセキュリティに関連する国等の基本文書白書解説文書 .list-paragraph}
...
### 各実施事項毎の参考情報【経営者、管理者向け】 {#各実施事項毎の参考情報経営者管理者向け .list-paragraph}
...
### 管理者向け実務資料 {#管理者向け実務資料 .list-paragraph}

### 一般ユーザ向け啓発資料【IT利用局面毎】 {#一般ユーザ向け啓発資料it利用局面毎 .list-paragraph}
...
### サイバーセキュリティ関連組織の参考サイト {#サイバーセキュリティ関連組織の参考サイト .list-paragraph}
...
## 6-3【Web版Appendix】セキュリティお役立ちリンク【追加候補】 {#web版appendixセキュリティお役立ちリンク追加候補 .list-paragraph}

### 主な文献のリストアップと複数文献を典拠とした内容の要約を纏める {#主な文献のリストアップと複数文献を典拠とした内容の要約を纏める .list-paragraph}
...
### 「サイバーセキュリティ経営ガイドライン」Ver2.0 付録B サイバーセキュリティ対策に関する参考情報の内容の反映 {#サイバーセキュリティ経営ガイドラインver2.0-付録b-サイバーセキュリティ対策に関する参考情報の内容の反映 .list-paragraph}

> [[https://www.meti.go.jp/policy/netsecurity/downloadfiles/CSM_Guideline_v2.0.pdf]{.underline}](https://www.meti.go.jp/policy/netsecurity/downloadfiles/CSM_Guideline_v2.0.pdf);

### 「テレワークセキュリティガイドライン第4版」【総務省】参考リンク集の内容を反映 {#テレワークセキュリティガイドライン第4版総務省参考リンク集の内容を反映 .list-paragraph}

> [[https://www.soumu.go.jp/main_content/000545372.pdf]{.underline}](https://www.soumu.go.jp/main_content/000545372.pdf);

### 【素材の列挙】主な文献のリスト {#素材の列挙主な文献のリスト .list-paragraph}
...
NIST 800-46 Guide to Enterprise Telework, Remote Access, and Bring Your
...
Bib05-01iCDスキルディクショナリ (スキル424項目・知識8256項目から抜粋)
...
### 主な情報サイトのリスト {#主な情報サイトのリスト .list-paragraph}
...
## 【Web版コラム】サイバーセキュリティ経営チェックシート {#web版コラムサイバーセキュリティ経営チェックシート .list-paragraph}

### 「サイバーセキュリティ経営ガイドライン」Ver2.0 付録A サイバーセキュリティ経営チェックシートの内容の反映 {#サイバーセキュリティ経営ガイドラインver2.0-付録a-サイバーセキュリティ経営チェックシートの内容の反映 .list-paragraph}
...
## 【Web版コラム】IoT機器調査及び利用者への注意喚起プロジェクト（NOTICE対応） {#web版コラムiot機器調査及び利用者への注意喚起プロジェクトnotice対応 .list-paragraph}

## 【Web版コラム】システム管理者としての基本技術の解説 {#web版コラムシステム管理者としての基本技術の解説 .list-paragraph}

### 【Web版コラム】システム管理者としての基本技術の解説 {#web版コラムシステム管理者としての基本技術の解説-1 .list-paragraph}

### （安全・安心ハンドブック（NISC）等を参照） {#安全安心ハンドブックnisc等を参照 .list-paragraph}

### ※クレジットカード　PCI/DSS（Payment Card Industry Data Security Standard） {#クレジットカード-pcidsspayment-card-industry-data-security-standard .list-paragraph}

### ※ブロックチェーン技術の応用 {#ブロックチェーン技術の応用 .list-paragraph}

### ※Wifiセキュリティ {#wifiセキュリティ .list-paragraph}

## 【Web版コラム】経営者向けサイバーセキュリティ経営のための啓発資料 {#web版コラム経営者向けサイバーセキュリティ経営のための啓発資料 .list-paragraph}

### 【Web版コラム】「Sec01-02_サイバーセキュリティ関連_各種ガイドブックの内容要約_インデックス」から「経営者向け」資料を抜粋【再掲】 {#web版コラムsec01-02_サイバーセキュリティ関連_各種ガイドブックの内容要約_インデックスから経営者向け資料を抜粋再掲 .list-paragraph}

> [[https://bluemoon55.github.io/Sharing_Knowledge3/MindManager3/Sec01-02.html]{.underline}](https://bluemoon55.github.io/Sharing_Knowledge3/MindManager3/Sec01-02.html);

### 【Web版コラム】Sec03-02_経営者向けサイバーセキュリティ経営の体系的啓発資料 {#web版コラムsec03-02_経営者向けサイバーセキュリティ経営の体系的啓発資料 .list-paragraph}
...
### 【Web版コラム】DAX43-01-1 ECサイトのサイバーセキュリティ対策の実践のために必要なスキル・知識 {#web版コラムdax43-01-1-ecサイトのサイバーセキュリティ対策の実践のために必要なスキル知識 .list-paragraph}
...
### 【Web版コラム】DAX20-0402-3 IT人材白書2018 {#web版コラムdax20-0402-3-it人材白書2018 .list-paragraph}
...
### 【Web版コラム】Sec01-02-10 ウェブサイト開設等における運営形態の選定方法に関する手引き {#web版コラムsec01-02-10-ウェブサイト開設等における運営形態の選定方法に関する手引き .list-paragraph}
...
### 【Web版コラム】DAX25-20-03【書籍】AI白書2019_第3章利用動向 {#web版コラムdax25-20-03書籍ai白書2019_第3章利用動向 .list-paragraph}

> [[https://bluemoon55.github.io/Sharing_Knowledge2/MindManager2/DAX25-20-03.html]{.underline}](https://bluemoon55.github.io/Sharing_Knowledge2/MindManager2/DAX25-20-03.html);

### 【Web版コラム】DAX25-20-05-5-6-3社会実装推進の方向性（テンプレート例） {#web版コラムdax25-20-05-5-6-3社会実装推進の方向性テンプレート例 .list-paragraph}
...
### 【Web版コラム】DAX22-01 AI・データの利用に関する契約ガイドライン（概要資料） {#web版コラムdax22-01-aiデータの利用に関する契約ガイドライン概要資料 .list-paragraph}
...
## 6-5：中小企業の情報セキュリティ対策ガイドライン【第3版】 {#中小企業の情報セキュリティ対策ガイドライン第3版 .list-paragraph}

### 「中小企業の情報セキュリティ対策ガイドライン第3版」の位置づけ、全体、活用方法、構成目次と要約を引用。IPAのページへリンク {#中小企業の情報セキュリティ対策ガイドライン第3版の位置づけ全体活用方法構成目次と要約を引用ipaのページへリンク .list-paragraph}

### 6-5(1)：本編の概要説明 {#本編の概要説明 .list-paragraph}

### 6-5(2)：情報セキュリティ5カ条 {#情報セキュリティ5カ条 .list-paragraph}

### 6-5(3)：情報セキュリティ基本方針 {#情報セキュリティ基本方針 .list-paragraph}

### 6-5(4)：新・5分でできる自社診断シート {#新5分でできる自社診断シート .list-paragraph}
...
> [[https://www.ipa.go.jp/security/benchmark/]{.underline}](https://www.ipa.go.jp/security/benchmark/);
...
9.無線LAN を利用する時は強固な暗号化を必ず利用するなどのように、 無線LAN
を安全に使うための対策をしていますか？
...
### 6-5(5)：情報セキュリティハンドブックひな形（従業員向け） {#情報セキュリティハンドブックひな形従業員向け .list-paragraph}
...
### 6-5(6)：情報セキュリティポリシーサンプル {#情報セキュリティポリシーサンプル .list-paragraph}

### 6-5(7)：情報セキュリティ関連規程の明文化 {#情報セキュリティ関連規程の明文化 .list-paragraph}
...
### 6-5(9)：情報資産台帳の作成 {#情報資産台帳の作成 .list-paragraph}

### 3-20⇒6-5(10)：リスク分析シート {#リスク分析シート .list-paragraph}
...
残留リスクによりセキュリティ侵害があった場合、 対応策を明確にしておく
...
### 6-5(11)：中小企業のためのクラウドサービス安全利用の手引き {#中小企業のためのクラウドサービス安全利用の手引き .list-paragraph}

## 6-6：IT人材育成・人材確保 {#it人材育成人材確保 .list-paragraph}

### 【担当：中山】 {#担当中山 .list-paragraph}

### ITSS {#itss .list-paragraph}
...
### 【参考】IT人材白書2017,2018,2019 {#参考it人材白書201720182019 .list-paragraph}
...
### iコンピテンシ・ディクショナリ(iCD) {#iコンピテンシディクショナリicd .list-paragraph}

iコンピテンシディクショナリについて

> [[https://www.ipa.go.jp/jinzai/hrd/i_competency_dictionary/]{.underline}](https://www.ipa.go.jp/jinzai/hrd/i_competency_dictionary/);
...
### 情報処理技術者試験制度 {#情報処理技術者試験制度 .list-paragraph}

【ポイント】全従業員は、社会人の常識とされる「ITパスポート試験レベル」のスキルを！

## 6-7：情報管理が不適切などの場合の処罰など {#情報管理が不適切などの場合の処罰など .list-paragraph}

### 制度・施策 {#制度施策 .list-paragraph}

IoT機器調査及び利用者への注意喚起プロジェクト（NOTICE対応）

情報セキュリティサービス審査登録制度及びシステム監査基準（2018年改訂）【METI/IPA】

> [[https://www.meti.go.jp/policy/netsecurity/shinsatouroku/touroku.html]{.underline}](https://www.meti.go.jp/policy/netsecurity/shinsatouroku/touroku.html);
...
> [[https://www.meti.go.jp/press/2019/05/20190517002/20190517002.html]{.underline}](https://www.meti.go.jp/press/2019/05/20190517002/20190517002.html);
...
### 関係法令：法律違反の可能性への対応方法の解説 {#関係法令法律違反の可能性への対応方法の解説 .list-paragraph}
...
不正指令電磁的記録に関する罪（ウイルス作成罪）, 電子計算機使用詐欺罪,
電子計算機損壊等業務妨害罪, 電磁的記録不正作出及び供用罪,
...
労働安全衛生法, 下請法, インターネットを利用した取引, 特定商取引法,
電子消費者契約法
...
# 付録 {#付録 .list-paragraph}

## 付-2：主な参考文献→【主な転載、引用文献】 {#付-2主な参考文献主な転載引用文献 .list-paragraph}

### 本書で引用した文献名一覧 {#本書で引用した文献名一覧 .list-paragraph}

### サイバーセキュリティ対策全般 {#サイバーセキュリティ対策全般 .list-paragraph}
...
### サイバー攻撃について {#サイバー攻撃について .list-paragraph}
...
### 個別のサイバー攻撃対策 {#個別のサイバー攻撃対策 .list-paragraph}
...
### 役に立つツール {#役に立つツール .list-paragraph}
...
## 付-3：用語解説インデックス {#付-3用語解説インデックス .list-paragraph}

### 参考資料 {#参考資料-1 .list-paragraph}
